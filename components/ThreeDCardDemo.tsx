    ...
    <CardContainer className="flex flex-wrap gap-3">
      <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border  ">
        ...
        <CardItem translateZ="100" className="w-full mt-4">
          <Image
            src="http://chrisnguyen.x10host.com/images/portfolio/yamaha_1200x1200.jpg"
            height="1000"
            width="1000"
      ...
      {/* <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border  ">
        ...
        <CardItem translateZ="100" className="w-full mt-4">
          <Image
            src="http://chrisnguyen.x10host.com/images/portfolio/boeing_1200x1200.jpg"
            height="1000"
            width="1000"
            className="h-60 w-full object-cover rounded-xl group-hover/card:shadow-xl"
            alt="thumbnail"
      ...
      {/* <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border  ">
        ...
        <CardItem translateZ="100" className="w-full mt-4">
          <Image
            src="http://chrisnguyen.x10host.com/images/portfolio/bb_1200x1200.jpg"
            height="1000"
            width="1000"
            className="h-60 w-full object-cover rounded-xl group-hover/card:shadow-xl"
            alt="thumbnail"
